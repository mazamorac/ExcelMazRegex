...
- 1.3.1 MAZ 2020-02-10
  - Changed the handling of the `input` text parameter: empty input strings do not trigger a #VALUE error anymore, `null` still does, though ExcelDNA doesn't seem to pass any nulls.
- 1.3 MAZ 2020-02-03
